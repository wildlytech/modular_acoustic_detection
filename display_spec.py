...
if __name__=="__main__":
    ...
    REQUIRED_ARGUMENTS.add_argument("-output_file_path",action="store",help="Output file path of location where plot is to be saved",required=True)
