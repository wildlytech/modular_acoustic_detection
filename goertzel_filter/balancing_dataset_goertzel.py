...
YOUTUBE_PURE_DATAPATH = 'goertzel_youtube_data/Datasets/pure/'
AUDIOMOTH_PURE_DATAPATH = "audiomoth_different_split_goertzel/pure/"

# Mixed sounds data path
AUDIOMOTH_MIXED_DATAPATH = "audiomoth_different_split_goertzel/mixed_sounds/"
YOUTUBE_MIXED_DATAPATH_AUGMENTED = "/media/wildly/Seagate/Embeddings_Aud_Mix_goertzel/"
