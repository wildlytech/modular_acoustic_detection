...
PARSER.add_argument('-path_for_dense_model_weights', '--path_for_dense_model_weights',
...
if RESULT.path_for_dense_model_weights:
    MODEL.load_weights(RESULT.path_for_dense_model_weights)
else:
